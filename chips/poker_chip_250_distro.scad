...
back_bitmap_graphic="default.svg";
...
[FILAMENT SETTINGS - 3 dots to right of filaments] -initial layer - white red blue; all others blue red white
Reduce flow ratio to 0.95 for blue and red filament only
SLICER SETTINGS PER OBJECT
[HEIGHT MODIFIER 3.1mm-3.5mm]
Layer Height = 0.1
